		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#brcomgestaodashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomgestaodashboard-display": {
								"semanticObject": "brcomgestaodashboard",
								"action": "display",
								"description": "Dashboard for Fiori Application",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.gestao.dashboard",
									"url": sap.ui.require.toUrl("br/com/gestao/dashboard")
								}
							}
						}
					}
